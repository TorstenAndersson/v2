...
function buy(sender) {
	...
	try {
		...
		localStorage["cart"] = localStorage["cart"].slice(0, -2) + JSON.stringify(JSON.parse(localStorage["cart"].slice(0, -1))[sender.parentElement.parentElement.firstElementChild.innerText + ">" + variant.slice(0, -2)].slice(0, -0) + 1) + ","
	} catch {
