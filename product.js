...
function variantChanged() {
	...
	for (const i2 in smallImgs) {
		console.log(smallImgs[i2].src.split("%20"[3]));
		smallImgs[i2].src = smallImgs[i2].src.replace(smallImgs[i2].src.split("%20"[3]), document.querySelector(".variantSelect").value);
	}
